...
public class SPasarBuah extends ListActivity
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortelp = "tel:0811-7565-757";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortelp));


            } else if (pilihan.equals("SMS Center")) {
                String smsText = "Selamat Datang di Pasar Buah Pekanbaru";
                ...
                String suplokasi = " https://g.co/kgs/614Zqm";
                ...
                a.putExtra(SearchManager.QUERY,"Pasar Buah Pekanbaru");
            }
