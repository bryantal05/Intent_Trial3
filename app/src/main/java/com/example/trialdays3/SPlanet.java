...
public class SPlanet extends ListActivity
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortelp = "tel:0761-674087";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortelp));


            } else if (pilihan.equals("SMS Center")) {
                String smsText = "Selamat Datang di Planet Swalayan";
                ...
                String suplokasi = "https://g.co/kgs/KyVoh6";
