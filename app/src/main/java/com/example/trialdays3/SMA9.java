...
public class SMA9 extends ListActivity
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortelp = "tel:0761-7071666";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortelp));


            } else if (pilihan.equals("SMS Center")) {
                String smsText = "Selamat Datang di SMA Negeri 9 Pekanbaru";
                ...
                String slokasi = " https://goo.gl/maps/4pBHbVrTEkAqRW876";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(slokasi));


            } else if (pilihan.equals("Website")) {

                String website = "http://sman9-pku.sch.id/";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));


            }else if (pilihan.equals("Info Google")){
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY,"SMA Negeri 9 Pekanbaru");
            }
