...
public class PPayungSekaki extends ListActivity
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortelp = "tel:0761-5637782";
                ...
                String plokasi = "https://g.co/kgs/xjjR6P";
                ...
                a.putExtra(SearchManager.QUERY,"Polsek Payung Sekaki");
            }
