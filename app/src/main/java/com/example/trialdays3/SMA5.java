...
public class SMA5 extends ListActivity
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortelp = "tel:0761-32075";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortelp));


            } else if (pilihan.equals("SMS Center")) {
                String smsText = "Selamat Datang di SMA Negeri 5 Pekanbaru";
                ...
                String slokasi = " https://goo.gl/maps/iTgfoo6EgeJ2GPBe9";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(slokasi));


            } else if (pilihan.equals("Website")) {

                String website = "https://www.sman5pekanbaru.sch.id/halaman/tentang";
